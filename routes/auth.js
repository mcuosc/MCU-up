...
router.get("/google/callback",passport.authenticate("google", {  scope: ["profile", 'email'], prompt: 'select_account', failureRedirect: '/auth/login', failureFlash: true}), authMethod.callbackByGoogle);
