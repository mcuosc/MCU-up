...
const updateComment = require("../models/_updateComment_model");
const deleteComment = require("../models/_deleteComment_model");
const getCourseList = require("../models/_courseList_model");
const getCourse = require("../models/_getCourses_model");
...
const checkComment = require("../models/_checkComment_model");
